...
# INSERT IGNORE INTO users (id, answer1, answer2, created_at, login, password, username, question1_id, question2_id) VALUES (0, 'whale', 'The Hunger Games', '2020-03-20 20:25', 'mike23', 'saj3do$a', 'mike23', 1, 3);
# INSERT IGNORE INTO users (id, answer1, answer2, created_at, login, password, username, question1_id, question2_id) VALUES (1, 'Capri', 'crocodile', '2020-03-20 16:08', 'tomHouston', 'ois5hefi#', 'tomHouston', 0, 1);
# INSERT IGNORE INTO users (id, answer1, answer2, created_at, login, password, username, question1_id, question2_id) VALUES (2, 'Ice Age', 'Jamaica', '2020-03-21 08:35', 'willDim', 'ib1ui%sfbs4d', 'willDim', 3, 0);
# INSERT IGNORE INTO users (id, answer1, answer2, created_at, login, password, username, question1_id, question2_id) VALUES (3, 'lion', 'Shrek', '2020-03-22 10:45', 'giGinella', 'ksn2dds6cs', 'giGinella', 1, 3);
# INSERT IGNORE INTO users (id, answer1, answer2, created_at, login, password, username, question1_id, question2_id) VALUES (4, 'Paris', 'koala', '2020-03-23 18:16', 'paulAven', 'inf5sdds7s', 'paulAven', 0, 1);
# INSERT IGNORE INTO users (id, answer1, answer2, created_at, login, password, username, question1_id, question2_id) VALUES (7, 'whale', 'The Hunger Games', '2020-03-10 00:01', 'test', 'testtest', 'test', 1, 3);
# INSERT IGNORE INTO users (id, answer1, answer2, created_at, login, password, username, question1_id, question2_id) VALUES (6, 'whale', 'The Hunger Games', '2020-03-20 20:25', 'test2', 'testtest', 'test2', 1, 3);
...
#
# INSERT IGNORE INTO multiplayer_game (id, bet, number_of_players, winner_id, status, host_id, player_one_id, player_two_id, player_three_id) VALUES (100, 450, 2, 1, 'ended', 1, 0, null, null);
# INSERT IGNORE INTO multiplayer_game (id, bet, number_of_players, winner_id, status, host_id, player_one_id, player_two_id, player_three_id) VALUES (101, 1249, 3, 4, 'ended', 4, 1, 5, null);
#  INSERT IGNORE INTO multiplayer_game (id, bet, number_of_players, winner_id, status, host_id, player_one_id, player_two_id, player_three_id) VALUES (102, 976, 2, null, 'pending', 2, null, null, null);
# INSERT IGNORE INTO multiplayer_game (id, bet, number_of_players, winner_id, status, host_id, player_one_id, player_two_id, player_three_id) VALUES (103, 1564, 2, null, 'pending', 3, null, null, null);
#  INSERT IGNORE INTO multiplayer_game (id, bet, number_of_players, winner_id, status, host_id, player_one_id, player_two_id, player_three_id) VALUES (104, 1855, 2, null, 'pending', 1, null, null, null);
#
#  INSERT IGNORE INTO game (id, game_date, game_time, level, score, score_lines, multiplayer_game_id, user_id) VALUES (9, '2020-03-20', '21:15:21', 9, 784, 105, 100, 0);
#  INSERT IGNORE INTO game (id, game_date, game_time, level, score, score_lines, multiplayer_game_id, user_id) VALUES (10, '2020-03-20', '21:15:21', 10, 1002, 120, 100, 1);
#  INSERT IGNORE INTO game (id, game_date, game_time, level, score, score_lines, multiplayer_game_id, user_id) VALUES (11, '2020-03-23', '19:00:55', 12, 1448, 146, 101, 2);
#  INSERT IGNORE INTO game (id, game_date, game_time, level, score, score_lines, multiplayer_game_id, user_id) VALUES (12, '2020-03-23', '19:00:55', 14, 1711, 187, 101, 3);
#  INSERT IGNORE INTO game (id, game_date, game_time, level, score, score_lines, multiplayer_game_id, user_id) VALUES (13, '2020-03-23', '19:00:55', 18, 4915, 285, 101, 4);
#
#  INSERT IGNORE INTO game (id, game_date, game_time, level, score, score_lines, multiplayer_game_id, user_id) VALUES (14, '2020-03-24', '11:15:47', 22, 7915, 368, 100, 0);
#  INSERT IGNORE INTO game (id, game_date, game_time, level, score, score_lines, multiplayer_game_id, user_id) VALUES (15, '2020-03-24', '11:15:47', 21, 7687, 345, 100, 1);
#  INSERT IGNORE INTO game (id, game_date, game_time, level, score, score_lines, multiplayer_game_id, user_id) VALUES (16, '2020-03-25', '15:32:25', 26, 16841, 438, 101, 2);
#  INSERT IGNORE INTO game (id, game_date, game_time, level, score, score_lines, multiplayer_game_id, user_id) VALUES (17, '2020-03-25', '15:32:25', 24, 12647, 402, 101, 3);
#  INSERT IGNORE INTO game (id, game_date, game_time, level, score, score_lines, multiplayer_game_id, user_id) VALUES (18, '2020-03-26', '17:50:00', 35, 32874, 854, 101, 4);
#  INSERT IGNORE INTO game (id, game_date, game_time, level, score, score_lines, multiplayer_game_id, user_id) VALUES (19, '2020-03-26', '17:50:00', 45, 54497, 1504, 101, 0);
#
...
#
# INSERT IGNORE INTO users (id, answer1, answer2, created_at, login, password, username, question1_id, question2_id) VALUES (5, 'Florida', 'parrot', '2020-03-24 13:40', 'SamFin', 'jnf2sd4ndd', 'SamFin', 0, 1);
